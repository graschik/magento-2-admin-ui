        ...
        openDialog: function (widgetUrl) {
            ...
            this.dialogWindow = jQuery('<div/>').modal({
                ...
                closed: function (e, modal) {
                    jQuery('body').trigger('widget-disappeared');
                    modal.modal.remove();
    ...
    WysiwygWidget.Widget.prototype = {
        ...
        loadOptions: function () {
            var optionsContainerId,
                ...
                visibleWidgetOptions;

            visibleWidgetOptions = jQuery(this.widgetOptionsEl).children().not('.no-display');
            if (visibleWidgetOptions.length) {
                if (visibleWidgetOptions.find('.widget-ui-components').length) {
                    jQuery('body').trigger('widget-disappeared');
                    visibleWidgetOptions.remove();
                }
            }
